...
INSTALLED_APPS = [
    ...
    # required for SIMPLE_JWT BLACKLIST_AFTER_ROTATION setting
    "rest_framework_simplejwt.token_blacklist",
    "rest_framework_swagger",  # used for OpenAPI documentation
    # Local
    # Add any new first party apps to config.toml too
    "users",
    "pages",
    "blog",
    "api",
...
ACCOUNT_SIGNUP_PASSWORD_ENTER_TWICE = (
    False  # only have to enter password once on signup
)
