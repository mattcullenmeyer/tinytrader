    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiftyTwoWeekHigh', models.DecimalField(decimal_places=2, max_digits=8)),
                ('fiftyTwoWeekLow', models.DecimalField(decimal_places=2, max_digits=8)),
                ...
                ('liquidity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.liquidity')),
